...
$kd_jns_pajak = '001'; //01 KODE JENIS HOTEL
$table_name   = 'HOTEL';
                        ...
                        <form name="sptpdForm" id="form" method="post" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <!-- <div class="form-group row">
                                        <label class="col-sm-3">Untuk SKPD : </label>
                                        <div class="col-sm-9">
                                            ...
                                            <input type="hidden" name="no_berkas" id="no_berkas" class="form-control" value="Sewa Ruang/Gedung" readonly="true" />
                                        ...
                                        <div class="col-sm-9">
                                            <div class='alert alert-warning' role='alert'>
                                                <div class="custom-file">
                                                    ...
                                                    <label class="custom-file-label" for="upFile" accept=".pdf" style="color:red;" required> *Upload file .pdf</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
