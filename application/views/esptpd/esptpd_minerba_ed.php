                    ...
                    <form name="sptpdForm" id="form" method="post">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="n" id="n" class="form-control-sm" value="<?= $npwprd ?>" readonly="true" style="background-color:azure;" />
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select name="spt_jenis_mblb" id="spt_jenis_mblb" class="form-control-sm" onchange="tarif_dasar()">
                                        <option value="<?= $mblb_id ?>"><?= $jenis_mblb ?></option>
                                        <?php
                                        foreach ($list_mblb as $row) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="spt_volume" id="spt_volume" size="11" value="<?= $volume ?>" class="form-control-sm" />
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="spt_tarif_dasar" id="spt_tarif_dasar" size="11" value="<?= $tarif_dasar ?>" class="form-control-sm" readonly style="background-color:azure" />
                                </td>
                            </tr>
...
<script>
    ...
    function save() {
        if ($('#disclamer').is(":checked")) {
            ...
            var url = "<?php echo site_url('esptpd') ?>";
