                    ...
                    <form name="sptpdForm" id="form" method="post" enctype="multipart/form-data">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="spt_nilai" id="spt_nilai" class="inputbox is-valid" size="25" onfocus="this.value=unformatCurrency(this.value);" onkeyup="hitung_pajak('spt_pajak','spt_nilai','korek_persen_tarif');" onblur="hitung_pajak('spt_pajak','spt_nilai','korek_persen_tarif');this.value=formatCurrency(this.value);" style="font-weight:bold;text-align:right;" required />
...
<script type="text/javascript">
    ...
    function hitung_pajak(objSptPajak, objDasarPengenaan, objPersen) {
        if ($('#' + objPersen).val() == "" && $('#' + objPersen).val() == 0) {
            ...
            if ($('#kegus_id').val() != '8' && unformatCurrency($('#' + objDasarPengenaan).val()) < 3000000) {
                var pajak = 0
            } else {
