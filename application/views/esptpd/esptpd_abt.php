                ...
                <div class="card card-info">
                    ...
                    <form name="sptpdForm" id="form" method="post" enctype="multipart/form-data">
                        <table class="table">
                            ...
                            <input type="hidden" name="spt_jenis" id="spt_jenis" class="form-control-sm" value="7" size="3" readonly="true" style="background-color:azure;" />
                            <!-- <tr>
                            ...
                            <!-- <tr>
                                <td colspan="2">
                                    <label>Petunjuk Meter Air</label>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="ptnjk_meter_hari_ini" id="ptnjk_meter_hari_ini" class="form-control-sm" style="text-align:right;" />
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="ptnjk_meter_bulan_lalu" id="ptnjk_meter_bulan_lalu" class="form-control-sm" style="text-align:right;" />
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="ptnjk_meter_volume" id="ptnjk_meter_volume" class="form-control-sm" style="text-align:right;" />
                                </td>
                            </tr>

                            <tr>
                                <td colspan="2">
                                    <label>Bukan Meter Air</label>
                                </td>
                            </tr>

                            <tr>
                                <td>
                                    <label>Penggunaan 1 hari</label>
                                </td>
                                <td>
                                    <input type="text" name="bkn_meter_hari" id="bkn_meter_hari" class="form-control-sm" style="text-align:right;" />
                                </td>
                            </tr>

                            <tr>
                                <td>
                                    <label>Penggunaan 1 bulan</label>
                                </td>
                                <td>
                                    <input type="text" name="bkn_meter_bulan" id="bkn_meter_bulan" class="form-control-sm" style="text-align:right;" />
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="bkn_meter_volume" id="bkn_meter_volume" class="form-control-sm" style="text-align:right;" />
                                </td>
                            </tr> -->
                            ...
                            <tr>
                                <td colspan="2">
                                    <table border="1" cellspacing="0" width="100%">
                                        <tr>
                                            <td style='text-align:center; vertical-align:middle'><label>Petunjuk Meter Air</label></td>
                                            <td style='text-align:center; vertical-align:middle'><label>Bukan Meter Air</label></td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <label>Hari Ini: </label><input type="text" name="ptnjk_meter_hari_ini" id="ptnjk_meter_hari_ini" class="form-control-sm" style="text-align:right;" />
                                            </td>
                                            <td>
                                                <label>Penggunaan 1 hari: </label><input type="text" name="bkn_meter_hari" id="bkn_meter_hari" class="form-control-sm" style="text-align:right;" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <label>Bulan Lalu: </label><input type="text" name="ptnjk_meter_bulan_lalu" id="ptnjk_meter_bulan_lalu" class="form-control-sm" style="text-align:right;" />
                                            </td>
                                            <td>
                                                <label>Penggunaan 1 bulan: </label><input type="text" name="bkn_meter_bulan" id="bkn_meter_bulan" class="form-control-sm" style="text-align:right;" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <label>Volume Air: </label><input type="text" name="ptnjk_meter_volume" id="ptnjk_meter_volume" class="form-control-sm" style="text-align:right;" />
                                            </td>
                                            <td>
                                                <label>Volume Air: </label><input type="text" name="bkn_meter_volume" id="bkn_meter_volume" class="form-control-sm" style="text-align:right;" />
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                            ...
                            <!-- <tr>
                                ...
                                <td>
                                    <input type="text" name="harga_satuan" id="harga_satuan" class="form-control-sm" style="text-align:right;" />
                                </td>
                            </tr>
...
<script type="text/javascript">
    ...
    $(document).on('keyup', "#harga_satuan", function() {
        ...
        let volume_meter = $('#ptnjk_meter_volume').val();
        let volume_non_meter = $('#bkn_meter_volume').val();
        let volume = 0
        if (volume_meter != '') {
            volume = volume_meter
        } else if (volume_non_meter != '') {
            volume = volume_non_meter;
        }
        let dasar_pengenaan = volume * harga_satuan;
