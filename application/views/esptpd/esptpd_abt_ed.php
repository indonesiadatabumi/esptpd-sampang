                    ...
                    <form name="sptpdForm" id="form" method="post" enctype="multipart/form-data">
                        <table class="table">
                            ...
                            <tr>
                                <td colspan="2">
                                    <table border="1" cellspacing="0" width="100%">
                                        ...
                                        <tr>
                                            <td>
                                                <label>Hari Ini: </label><input type="text" name="ptnjk_meter_hari_ini" id="ptnjk_meter_hari_ini" class="form-control-sm" value="<?= $data_abt->ptnjk_meter_hari_ini ?>" style="text-align:right;" />
                                            </td>
                                            <td>
                                                <label>Penggunaan 1 hari: </label><input type="text" name="bkn_meter_hari" id="bkn_meter_hari" class="form-control-sm" value="<?= $data_abt->bkn_meter_hari ?>" style="text-align:right;" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <label>Bulan Lalu: </label><input type="text" name="ptnjk_meter_bulan_lalu" id="ptnjk_meter_bulan_lalu" class="form-control-sm" value="<?= $data_abt->ptnjk_meter_bulan_lalu ?>" style="text-align:right;" />
                                            </td>
                                            <td>
                                                <label>Penggunaan 1 bulan: </label><input type="text" name="bkn_meter_bulan" id="bkn_meter_bulan" class="form-control-sm" value="<?= $data_abt->bkn_meter_bulan ?>" style="text-align:right;" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <label>Volume Air: </label><input type="text" name="ptnjk_meter_volume" id="ptnjk_meter_volume" class="form-control-sm" value="<?= $data_abt->ptnjk_meter_volume ?>" style="text-align:right;" />
                                            </td>
                                            <td>
                                                <label>Volume Air: </label><input type="text" name="bkn_meter_volume" id="bkn_meter_volume" class="form-control-sm" value="<?= $data_abt->bkn_meter_volume ?>" style="text-align:right;" />
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="harga_satuan" id="harga_satuan" value="<?= $tarif_dasar ?>" class="form-control-sm" style="text-align:right;" />
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="spt_nilai" id="spt_nilai" class="inputbox is-valid" size="25" value="<?= $dasar_pengenaan ?>" onfocus="this.value=unformatCurrency(this.value);" onkeyup="getPajak('spt_pajak','spt_nilai','korek_persen_tarif');" onblur="getPajak('spt_pajak','spt_nilai','korek_persen_tarif');this.value=formatCurrency(this.value);" style="background-color:azure;font-weight:bold;text-align:right;" required />
