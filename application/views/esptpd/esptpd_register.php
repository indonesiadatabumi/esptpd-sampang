        ...
        <div class="row">
            <div class="col-12">
                <div class="card-header bg-light">
                    <h3 class="card-title"><i class="fa fa-list text-blue"></i> Verifikasi ESPTPD</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    <?php
                    ...
                    <div class="modal-body">
                        ...
                        <form id='form' name='form' class='form-horizontal form-label-left' method='POST'>
                            ...
                            <div class=" form-group">
                                ...
                                <input type="checkbox" name="stat_regis" id="stat_regis" value="1" <?= ($stat_register == '1') ? 'checked' : '' ?>>
                            </div>

                            <div class="form-group">
                                <span class="label label-primary">Keterangan :</span>
                                <!-- <input type="text" class="form-control keterangan" style="text-align:right;"> -->
                                <textarea class="form-control" name="ket_register" id="ket_register"><?= $keterangan; ?></textarea>
                            </div>
                    </div>
                </div>
