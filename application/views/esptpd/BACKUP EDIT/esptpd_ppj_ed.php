                        ...
                        <table class="table">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="text" name="spt_dt_id" id="spt_dt_id" class="form-control-sm" value="<?= $spt_dt_id ?>" size="3" readonly="true" style="background-color:azure;" />
                                ...
                                <td>
                                    <select name="nama_rekening" style="width:300px; ">
                                        ...
                                        foreach ($v_rekening as $rekening) {
                                            if ($spt_dt_korek == $rekening->korek_id)
                                                echo " <option value='" . $rekening->korek_id . "' selected >" . $rekening->korek_nama . "</option>";
                                            else
                                                echo " <option value='" . $rekening->korek_id . "'  >" . $rekening->korek_nama . "</option>";
                                        ?>
                                        <?php
                                        }
                                        ?>
                                    </select>
                                    <input type="hidden" size="4" name="kode_rekening_id" id="kode_rekening_id" value="<?= $spt_dt_korek ?>">
                                </td>
                            </tr>
                            <tr>
                                <td><label for="pajak Terutang">Pajak Terhutang </label></td>
                                <td>
                                    <input type="text" name="spt_pajak" id="spt_pajak" class="form-control-sm is-valid" size="20" onfocus="this.value=unformatCurrency(this.value);" value="<?= $spt_pajak ?>" onkeyup="getPengenaan('spt_pajak','spt_nilai','korek_persen_tarif');" onblur="getPengenaan('spt_pajak','spt_nilai','korek_persen_tarif');this.value=formatCurrency(this.value);" style="font-weight:bold;font-size:25px;color:#18F518;background-color:gray;text-align:right;" required />
                                </td>
                            </tr>
                            <tr>
                                <td>Dasar Pengenaan
                                ...
                                <td>
                                    <input type="text" name="spt_nilai" id="spt_nilai" class="inputbox is-valid" size="25" readonly="true" value="<?= $dasar_pengenaan ?>" style="font-weight:bold;text-align:right;background-color:azure;" required />
                                    Tarif (%) : <select name="korek_persen_tarif" id="korek_persen_tarif">
                                        <option value="1.5" <?php if ($spt_dt_persen_tarif == '1.5') echo 'selected'; ?>>1.5</option>
                                        <option value="5" <?php if ($spt_dt_persen_tarif == '5') echo 'selected'; ?>>5</option>
                                        <option value="7" <?php if ($spt_dt_persen_tarif == '7') echo 'selected'; ?>>7</option>
                                    </select> %
                                </td>
                            </tr>
                            <tr>
