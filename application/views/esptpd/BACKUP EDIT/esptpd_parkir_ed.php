                    ...
                    <form name="sptpdForm" id="form" method="post" enctype="multipart/form-data">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="spt_tgl_proses" id="spt_tgl_prosess" value="<?= $spt_tgl_proses ?>" class="mandatory" size="12" readonly />
                                </td>
                            </tr>
                            <tr>
                                <td class="key">
                                ...
                                <td>
                                    <input type="text" name="spt_tgl_entry" id="spt_tgl_entryy" value="<?= $spt_tgl_entry ?>" class="mandatory" size="12" readonly="true" style="background-color:azure;" />
                                </td>
                            </tr>
                            <tr>
                                <td class="key">
