                    ...
                    <form name="sptpdForm" id="form" method="post" enctype="multipart/form-data">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="kd_rekening" id="kd_rekening" class="form-control-sm" value="41101" size="30" readonly="true" style="background-color:azure;" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <label for="name">Golongan Hotel </label>
                                </td>
                                <td>
                                    <select name="nama_rekening" id="nama_rekening" style="width:200px; ">
                                        <option value=""> -- Pilih Golongan Hotel --</option>
                                        <?php
                                        foreach ($list_rekening as $l) {
                                        ?>
                                            <option value="<?= $l->korek_id ?>"><?= $l->korek_nama ?> </option>
                                        <?php }
                                        ?>
                                    </select>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <label for="dasar pengenaan"> Tarif (%) : </label> <input type="text" name="korek_persen_tarif" id="korek_persen_tarif" class="inputbox is-valid" size="5" readonly="true" style="font-weight:bold;background-color:azure;text-align:right;" required />
                                </td>
                            </tr>
                            <tr>
