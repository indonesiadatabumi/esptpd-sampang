            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header bg-light">
                        <h3 class="card-title"><i class="fa fa-list text-blue"></i> Informasi Pembayaran</h3>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $("#tbl_bayar").DataTable({
            ...
            "autoWidth": false,
            "language": {
                "sEmptyTable": "Data Pembayaran belum ada"
            },
            ...
            "columnDefs": [{
                    ...
                    "render": function(data, type, row) {
                        ...
                        return "<a class=\"btn btn-xs btn-warning\" href=\"javascript:void(0)\" title=\"Edit\" onclick=\"batalbayar(" + row[2] + ")\"><i class=\"fas fa-warning\"></i>Btl Byr</a>";
    ...
    function update(id) {
        ...
        swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url: "<?php echo site_url('pembayaran/pembatalan'); ?>",
                    type: "POST",
                    data: "id=" + id,
                    cache: false,
                    dataType: 'json',
    ...
    function batalbayar(id) {
        swal.fire({
            title: 'Are you sure?',
            text: "Yakin melakukan pembatalan ?",
            type: 'warning',
            showCancelButton: true,
            confirmButtonText: 'Yes'
        }).then(function(result) {
