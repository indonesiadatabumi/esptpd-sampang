        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <table id="list_sptpd_skpd" class="table table-bordered table-striped table-hover">
                            <thead>
                                <tr class="bg-info">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        //datatables
        table = $("#list_sptpd_skpd").DataTable({
            "responsive": true,
            "autoWidth": false,
            "language": {
            ...
            "ajax": {
                "url": "<?php echo site_url('pelayanan/list_sptpd_skpd') ?>",
                "type": "POST"
            },
