    ...
    <script type="text/javascript">
      ...
      function cekNPWPD(val) {
         //alert('npwp' + $('#level').val());
        var level = $('#level').val();
        var npwpd = val;
        if (level == '4') {
          $.ajax({
            type: "POST",
            url: "<?= site_url('user/get_namawp') ?>",
            dataType: "JSON",
            data: {
              npwpd: npwpd
            },
            ...
            <form action="#" id="form" class="form-horizontal" enctype="multipart/form-data">
              ...
              <div class="card-body">
                ...
                <div class="form-group row ">
                  ...
                  <div class="col-sm-9 kosong">
                    <input type="text" class="form-control" name="username" id="username" onblur="cekNPWPD(this.value)" placeholder="Username">
                    <p id="namawp" style="font-style: oblique; font-size:medium; color:red; text-align:right"></p>
                  </div>
                </div>
                <div class="form-group row ">
